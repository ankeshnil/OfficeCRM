...
namespace OfficeCRM.Models.DataAccess
{
	...
	internal sealed class DataManager : IDisposable
	{
		...
		public DataManager()
		{
			...
			strConnectionString = "Server=ANKESH\\SQLEXPRESS;Initial Catalog=OfficeCRMDB;Trusted_Connection=True;MultipleActiveResultSets=true";
		...
		public int ExecuteNonQuery(string ExecuteString)
		{
			...
			{
				SqlCmd.CommandTimeout = 200;//Convert.ToInt32(System.Configuration.ConfigurationSettings.AppSettings["CommandTimeout"]);
